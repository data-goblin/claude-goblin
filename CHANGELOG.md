...
### Changed
- Hermes usage examples and regression fixtures now use neutral device,
  provider, model, and filesystem names. The ingestion format remains
  independent of any particular agent persona, host, local inference server,
  or hosted model provider
